...
Stage 12B full-system visual/UI calibration is active. Through the public `f87b6e30c7f06c208b6476120591db0eec790030` checkpoint and the current Home finishing candidate, the following calibration state is accepted:
...
2. transient interaction surfaces, including Peek, Bulk Bar, Action/Context Menu, Picker/Popover, Confirmation, Cycle lifecycle surfaces, and the still-open unselected-row Delete -> Esc focus-visible checkbox ambiguity plus Project lifecycle/Bulk/Delete micro-calibration;
...
4. remaining local visual surfaces: Project/Current Cycle Board and Workflow Issue Card consistency, Projects Timeline, Triage Review, Issue Full Item, Cycle Start/Add Issues/Close flows, and Sidebar Search against the newly calibrated shell scale;
