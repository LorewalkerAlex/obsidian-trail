...
export function TrailWorkTrendWidget({
  ...
  return (
    <TrailHomeWidgetFrame meta={rangeLabel} size="wide" title="Work trend">
      {!hasHistory || days.length === 0 ? (
        <div className="trail-home-work-trend__empty">No workflow history yet</div>
      ) : (
